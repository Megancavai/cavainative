setTimeout(function(){ 
 ...
 // Converse ID 1523-2882-3838-20529 generated 2022-08-11T07:20:40.297Z
    (function() {
        function async_load(target){
            var s = target.document.createElement('script');
            s.type = 'text/javascript';
            s.id = 'cavai-script';
            var theUrl = 'https://cloud.cavai.com/js/converses/widgets/converse-widget.15af99203b2d761f2063073a1b67f2e1.min.js?bust=' + Date.now();
            s.src = theUrl;
            s.async = true;
